...
public class PC {
	...
	public void usandoPc(int idPersona) throws InterruptedException {
		...
		synchronized (this) {
			...
			Coworking.showMessage("("+idPersona+".4) La persona F" + idPersona + " está usando el PC");
			this.setEstado(true);
		}
	}
	...
	public void saliendoPc(int idPersona) {
		...
		synchronized (this) {
			...
			Coworking.showMessage("("+idPersona+".5) La persona F" + idPersona + " ha dejado de usar el PC");
			this.notifyAll();
		}
	}
